...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference("Seller.count") do
      post sellers_url, params: { seller: { condition_id: @seller.condition_id, product_id: @seller.product_id, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { condition_id: @seller.condition_id, product_id: @seller.product_id, user_id: @seller.user_id } }
